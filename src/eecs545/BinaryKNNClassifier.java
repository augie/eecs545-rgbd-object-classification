 ...
 * @author Augie
 */
public class BinaryKNNClassifier extends BinaryClassifier {
    ...
    public BinaryKNNClassifier(int label, int K) {
        super(label);
        this.K = K;
    }
    ...
    @Override
    public BinaryResults test(List<Input> test) throws Exception {
...
//                distance = Math.sqrt(distance);
            ...
            results.add(unknown, pluralityLabel == label);
        }
        return results;
    }
}
